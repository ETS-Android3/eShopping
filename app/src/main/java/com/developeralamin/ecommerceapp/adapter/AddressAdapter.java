...
import com.developeralamin.ecommerceapp.models.AddressModel;
...
public class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder> {
    ...
    private RadioButton setlectedRadiobtn;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.radioButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (setlectedRadiobtn!=null){
                    setlectedRadiobtn.setChecked(false);
                }
                setlectedRadiobtn = (RadioButton) v;
                setlectedRadiobtn.setChecked(true);
