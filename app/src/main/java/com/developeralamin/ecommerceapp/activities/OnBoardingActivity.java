...
import com.developeralamin.ecommerceapp.adapter.SliderApapter;
...
//        getSupportActionBar().hide();
        ...
        sliderApapterl = new SliderApapter(this);
        viewPager.setAdapter(sliderApapterl);
